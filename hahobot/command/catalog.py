...
_COMMAND_SPECS: tuple[CommandSpec, ...] = (
    ...
    CommandSpec(
        command="/dream",
        description_keys=("cmd_dream", "cmd_dream_log", "cmd_dream_restore"),
        usage_lines=(
            "/dream",
            "/dream log",
            "/dream log <sha>",
        ...
        note_key="admin_commands_note_dream",
        completion_subcommands=("log", "restore"),
        prefix_match=True,
        help_rank=120,
        admin_rank=110,
    ...
    CommandSpec(
        ...
        completion_subcommands=("current", "list", "show", "export", "use", "new"),
        note_key="admin_commands_note_session",
        prefix_match=True,
        telegram_menu_enabled=False,
    ...
    CommandSpec(
        command="/compact",
        description_keys=("cmd_compact",),
        usage_lines=(
            "/compact",
            "/compact <key>",
        ),
        note_key="admin_commands_note_compact",
        prefix_match=True,
        telegram_menu_enabled=False,
        interactive_rank=190,
        help_rank=148,
        admin_rank=129,
    ),
)
