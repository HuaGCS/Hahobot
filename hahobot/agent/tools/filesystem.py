...
from hahobot.agent.tools.schema import BooleanSchema, IntegerSchema, StringSchema, tool_parameters_schema
from hahobot.utils.helpers import build_image_content_blocks, detect_image_mime
