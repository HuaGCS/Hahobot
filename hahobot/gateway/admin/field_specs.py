...
_CONFIG_FIELDS = (
    ...
    ConfigFieldSpec(
        ...
        ("api", "host"),
        "text",
        "admin_config_api_host_label",
        "admin_config_api_host_hint",
    ...
    ConfigFieldSpec(
        ...
        ("a2a", "enabled"),
        "bool",
        "admin_config_a2a_enabled_label",
        "admin_config_a2a_enabled_hint",
        restart_required=True,
    ),
    ConfigFieldSpec(
        "a2a_streaming",
        ("a2a", "streaming"),
        "bool",
        "admin_config_a2a_streaming_label",
        "admin_config_a2a_streaming_hint",
        restart_required=True,
    ),
    ConfigFieldSpec(
        "a2a_name",
    ...
    ConfigFieldSpec(
        ...
        ("a2a", "description"),
        "text",
        "admin_config_a2a_description_label",
        restart_required=True,
    ),
    ConfigFieldSpec(
        "a2a_version",
        ("a2a", "version"),
        "text",
        "admin_config_a2a_version_label",
        restart_required=True,
    ),
    ConfigFieldSpec(
        "a2a_public_url",
        ("a2a", "publicUrl"),
        "text",
        "admin_config_a2a_public_url_label",
        "admin_config_a2a_public_url_hint",
    ...
    ConfigFieldSpec(
        ...
        ("a2a", "timeout"),
        "float",
        "admin_config_a2a_timeout_label",
        restart_required=True,
    ),
    ConfigFieldSpec(
        "a2a_max_tasks",
        ("a2a", "maxTasks"),
        "int",
        "admin_config_a2a_max_tasks_label",
        "admin_config_a2a_max_tasks_hint",
        restart_required=True,
    ),
    ConfigFieldSpec(
    ...
    ConfigFieldSpec(
        ...
        ("memory", "shared", "enabled"),
        "bool",
        "admin_config_memory_shared_enabled_label",
        "admin_config_memory_shared_enabled_tooltip",
    ),
    ConfigFieldSpec(
        "memory_shared_provider",
        ("memory", "shared", "provider"),
        "select",
        "admin_config_memory_shared_provider_label",
        "admin_config_memory_shared_provider_tooltip",
        options=("mem0",),
    ),
    ConfigFieldSpec(
        "memory_shared_base_url",
        ("memory", "shared", "baseUrl"),
        "text",
        "admin_config_memory_shared_base_url_label",
        "admin_config_memory_shared_base_url_tooltip",
        placeholder="http://nas.local:8000",
    ),
    ConfigFieldSpec(
        "memory_shared_api_key",
        ("memory", "shared", "apiKey"),
        "text",
        "admin_config_memory_shared_api_key_label",
        "admin_config_memory_shared_api_key_tooltip",
    ),
    ConfigFieldSpec(
        "memory_shared_user_id",
        ("memory", "shared", "userId"),
        "text",
        "admin_config_memory_shared_user_id_label",
        "admin_config_memory_shared_user_id_tooltip",
        placeholder="hua-global-v1",
    ),
    ConfigFieldSpec(
        "memory_shared_agent_id",
        ("memory", "shared", "agentId"),
        "text",
        "admin_config_memory_shared_agent_id_label",
        "admin_config_memory_shared_agent_id_tooltip",
        placeholder="hahobot",
    ),
    ConfigFieldSpec(
        "memory_shared_project_id",
        ("memory", "shared", "projectId"),
        "text",
        "admin_config_memory_shared_project_id_label",
        "admin_config_memory_shared_project_id_tooltip",
        placeholder="HuaGCS/Hahobot",
    ),
    ConfigFieldSpec(
        "memory_shared_device_id",
        ("memory", "shared", "deviceId"),
        "text",
        "admin_config_memory_shared_device_id_label",
        "admin_config_memory_shared_device_id_tooltip",
    ...
    ConfigFieldSpec(
        ...
        "bool",
        "admin_config_memory_shared_persona_enabled_label",
        "admin_config_memory_shared_persona_enabled_tooltip",
    ),
    ConfigFieldSpec(
        "memory_shared_persona_user_id_prefix",
        ("memory", "shared", "personaUserIdPrefix"),
        "text",
        "admin_config_memory_shared_persona_user_id_prefix_label",
        "admin_config_memory_shared_persona_user_id_prefix_tooltip",
        placeholder="hua-global-v1::hahobot-persona",
    ),
    ConfigFieldSpec(
        "memory_shared_global_write_mode",
        ("memory", "shared", "globalWriteMode"),
        "select",
        "admin_config_memory_shared_global_write_mode_label",
        "admin_config_memory_shared_global_write_mode_tooltip",
        options=("full", "user_only", "off"),
    ),
    ConfigFieldSpec(
        "memory_shared_read_enabled",
        ("memory", "shared", "readEnabled"),
        "bool",
        "admin_config_memory_shared_read_enabled_label",
        "admin_config_memory_shared_read_enabled_tooltip",
    ),
    ConfigFieldSpec(
        "memory_shared_write_enabled",
        ("memory", "shared", "writeEnabled"),
        "bool",
        "admin_config_memory_shared_write_enabled_label",
        "admin_config_memory_shared_write_enabled_tooltip",
    ),
    ConfigFieldSpec(
        "memory_shared_top_k",
        ("memory", "shared", "topK"),
        "int",
        "admin_config_memory_shared_top_k_label",
        "admin_config_memory_shared_top_k_tooltip",
    ),
    ConfigFieldSpec(
        "memory_shared_max_context_chars",
        ("memory", "shared", "maxContextChars"),
        "int",
        "admin_config_memory_shared_max_context_chars_label",
        "admin_config_memory_shared_max_context_chars_tooltip",
    ),
    ConfigFieldSpec(
        "memory_shared_timeout_seconds",
        ("memory", "shared", "timeoutSeconds"),
        "float",
        "admin_config_memory_shared_timeout_seconds_label",
    ...
    ConfigFieldSpec(
        ...
        "int",
        "admin_config_memory_shared_snapshot_refresh_seconds_label",
        "admin_config_memory_shared_snapshot_refresh_seconds_tooltip",
    ),
    ConfigFieldSpec(
...
_CONFIG_SECTIONS = (
    ...
    (
        "admin_config_section_shared_memory_title",
        "admin_config_section_shared_memory_desc",
        (
            "memory_shared_enabled",
            "memory_shared_provider",
            "memory_shared_base_url",
